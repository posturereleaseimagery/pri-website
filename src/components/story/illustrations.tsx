...
export function DorsalVentralFigure({ className, highlight }: { className?: string; highlight?: "dorsal" | "ventral" | "both" }) {
  ...
  return (
    <svg viewBox="0 0 200 400" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Back half of head */}
      <path d="M100 20 A28 32 0 0 0 100 84" fill="var(--primary)" opacity={dorsalOpacity} />
      {/* Front half of head */}
      <path d="M100 20 A28 32 0 0 1 100 84" fill="var(--warm)" opacity={ventralOpacity} />
  ...
  return (
    <svg viewBox="0 0 240 400" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {[80, 120, 160, 200, 240, 280, 320].map((y) => (
        <g key={y}>
          <line x1="114" y1={y} x2="108" y2={y} stroke="var(--warm)" strokeWidth="1" opacity="0.4" />
          <line x1="126" y1={y} x2="132" y2={y} stroke="var(--warm)" strokeWidth="1" opacity="0.4" />
        </g>
      ))}
    </svg>
  );
...
export function EggFigure({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 280" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ellipse cx="100" cy="150" rx="65" ry="90" fill="var(--warm)" opacity="0.08" />
      <ellipse cx="100" cy="150" rx="65" ry="90" stroke="var(--warm)" strokeWidth="1.5" opacity="0.3" />

      {/* Back half — dorsal shell */}
      <path d="M100 60 A65 90 0 0 0 100 240" fill="var(--primary)" opacity="0.12" stroke="var(--primary)" strokeWidth="1" strokeOpacity="0.25" />

      {/* Front half — ventral opening */}
      <path d="M100 60 A65 90 0 0 1 100 240" fill="var(--warm)" opacity="0.12" stroke="var(--warm)" strokeWidth="1" strokeOpacity="0.25" />

      {/* Inner warmth */}
      <ellipse cx="100" cy="150" rx="35" ry="50" fill="var(--warm)" opacity="0.06" />

      {/* Seam line */}
      <line x1="100" y1="60" x2="100" y2="240" stroke="var(--warm)" strokeWidth="1.5" opacity="0.4" strokeDasharray="3 5" />
    </svg>
  );
}
...
export function IntegratedFigure({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 420" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M100 20 A24 28 0 0 0 100 76" fill="var(--primary)" opacity="0.12" />
      <path d="M100 20 A24 28 0 0 1 100 76" fill="var(--warm)" opacity="0.12" />
      ...
      {/* Legs */}
      <path d="M96 340 C94 360 92 380 88 400" stroke="var(--primary)" strokeWidth="1.5" opacity="0.25" strokeLinecap="round" />
      <path d="M104 340 C106 360 108 380 112 400" stroke="var(--warm)" strokeWidth="1.5" opacity="0.25" strokeLinecap="round" />

      {/* Arms — open, relaxed */}
      <path d="M92 90 C78 110 65 140 58 170" stroke="var(--primary)" strokeWidth="1.2" opacity="0.2" strokeLinecap="round" />
      <path d="M108 90 C122 110 135 140 142 170" stroke="var(--warm)" strokeWidth="1.2" opacity="0.2" strokeLinecap="round" />

      {/* Subtle upward energy lines */}
      <line x1="100" y1="400" x2="100" y2="10" stroke="var(--warm)" strokeWidth="0.5" opacity="0.08" />
...
export function EvolutionSequence({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 600 200" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Water / Fish */}
      <g opacity="0.5">
        <ellipse cx="80" cy="110" rx="40" ry="15" fill="var(--primary)" opacity="0.1" stroke="var(--primary)" strokeWidth="1" />
        <path d="M120 110 L140 95 L140 125 Z" fill="var(--primary)" opacity="0.1" stroke="var(--primary)" strokeWidth="1" />
        <line x1="80" y1="95" x2="80" y2="125" stroke="var(--warm)" strokeWidth="0.8" strokeDasharray="2 3" opacity="0.4" />
        <text x="65" y="155" fontSize="9" fill="currentColor" opacity="0.4">water</text>
      </g>

      {/* Amphibian */}
      <g opacity="0.5">
        <ellipse cx="220" cy="120" rx="35" ry="12" fill="var(--primary)" opacity="0.1" stroke="var(--primary)" strokeWidth="1" />
      ...
      {/* Quadruped */}
      <g opacity="0.5">
        <path d="M340 105 C350 90 380 85 400 90 C410 93 415 100 415 108" fill="var(--primary)" opacity="0.08" stroke="var(--primary)" strokeWidth="1" strokeOpacity="0.3" />
        <path d="M340 108 C345 118 370 125 390 122 C410 118 415 112 415 108" fill="var(--warm)" opacity="0.08" stroke="var(--warm)" strokeWidth="1" strokeOpacity="0.3" />
      ...
      <g opacity="0.6">
        ...
        <path d="M530 69 C528 80 526 100 526 120 C526 140 527 155 530 170" stroke="var(--primary)" strokeWidth="1.5" opacity="0.3" />
        <path d="M530 69 C532 80 534 100 534 120 C534 140 533 155 530 170" stroke="var(--warm)" strokeWidth="1.5" opacity="0.3" />
        <line x1="530" y1="69" x2="530" y2="170" stroke="var(--warm)" strokeWidth="1" opacity="0.3" strokeDasharray="2 3" />
